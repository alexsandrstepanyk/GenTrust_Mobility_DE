...
function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ctx.reply("👋 Hallo, zukünftiger Scout! Lass uns dich registrieren.\n\nIn welcher Stadt wohnst du? (z.B. Würzburg, Kyiv)")];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!city)
                    return [2 /*return*/, ctx.reply("Bitte gib den Stadtnamen als Text ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.city = city;
                return [4 /*yield*/, ctx.reply("📍 Und in welchem Bezirk? (z.B. Zellerau, Altstadt)")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!district)
                    return [2 /*return*/, ctx.reply("Bitte gib den Bezirksnamen als Text ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.district = district;
                return [4 /*yield*/, ctx.reply("✍️ Wie heißt du? (Vorname)")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!firstName)
                    return [2 /*return*/, ctx.reply("Gib deinen Vornamen als Text ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.firstName = firstName;
                return [4 /*yield*/, ctx.reply("✍️ Dein Nachname?")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!lastName)
                    return [2 /*return*/, ctx.reply("Gib deinen Nachnamen als Text ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.lastName = lastName;
                return [4 /*yield*/, ctx.reply("📅 Geburtsdatum? (Format: TT.MM.JJJJ, z.B. 12.05.2010)")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!birthDate)
                    return [2 /*return*/, ctx.reply("Gib das Datum als Text ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.birthDate = birthDate;
                return [4 /*yield*/, ctx.reply("🏫 In welche Schule gehst du?")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!school)
                    return [2 /*return*/, ctx.reply("Gib den Schulnamen ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.school = school;
                return [4 /*yield*/, ctx.reply("🎓 In welcher Klasse bist du? (z.B. 7-A)")];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
        }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!grade)
                    return [2 /*return*/, ctx.reply("Gib deine Klasse ein.")];
                if (ctx.session.onboarding)
                    ctx.session.onboarding.grade = grade;
                data = ctx.session.onboarding;
                return [4 /*yield*/, ctx.reply("\uD83D\uDD0D Pr\u00FCfe deine Daten:\n      \n\uD83D\uDC65 ".concat(data === null || data === void 0 ? void 0 : data.firstName, " ").concat(data === null || data === void 0 ? void 0 : data.lastName, "\n\uD83D\uDCC5 ").concat(data === null || data === void 0 ? void 0 : data.birthDate, "\n\uD83C\uDFEB ").concat(data === null || data === void 0 ? void 0 : data.school, ", Klasse ").concat(data === null || data === void 0 ? void 0 : data.grade, "\n\uD83D\uDCCD Stadt: ").concat(data === null || data === void 0 ? void 0 : data.city, "\n\uD83C\uDFE0 Bezirk: ").concat(data === null || data === void 0 ? void 0 : data.district, "\n\n\uD83D\uDCDC Scout-Kodex:\n1. Ich verspreche, ehrlich zu sein.\n2. Ich k\u00FCmmere mich um meine Stadt.\n3. Ich helfe anderen.\n\nStimmst du zu und sind die Daten korrekt?"), telegraf_1.Markup.inlineKeyboard([
                        telegraf_1.Markup.button.callback("✅ Ja, registrieren", "agree_code"),
                        telegraf_1.Markup.button.callback("❌ Nein, neu starten", "restart_onboarding")
                    ]))];
            case 1:
                _b.sent();
                return [2 /*return*/, ctx.wizard.next()];
...
// Step 8: Save to DB
function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var callbackData, data, updatedUser, adminChatId, adminMsg;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, ctx.answerCbQuery("Wir starten von vorne...")];
            case 1:
                _b.sent();
                ctx.scene.enter("onboarding"); // Re-enter
                return [2 /*return*/];
            case 2:
                if (!(callbackData === "agree_code")) return [3 /*break*/, 8];
                return [4 /*yield*/, ctx.answerCbQuery()];
            case 3:
                _b.sent();
                data = ctx.session.onboarding;
                if (!(ctx.user && data)) return [3 /*break*/, 6];
